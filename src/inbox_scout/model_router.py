...
def _build_prompt(email: dict, rule_result: dict) -> str:
    return (
        ...
        "Distinguishing marketing from security/orders (look at full context, not isolated words):\n"
        "- 'recover your cart' or 'still looking' is marketing (Promotion).\n"
        "- 'recovery email updated' or 'verification code' is Security alert (manual_review).\n"
        "- 'free shipping sale' or 'summer looks' is marketing (Promotion/Newsletter).\n"
        "- 'your package shipped/delivered', 'tracking number', or 'order confirmation' "
        "is a real shipping/order email (Bills/receipts, manual_review).\n"
        "- 'we miss you', 'new arrivals', 'daily digest', or 'shop now' is marketing.\n\n"
